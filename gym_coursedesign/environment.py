...
import numpy as np
import random
from gym_coursedesign.multi_discrete import MultiDiscrete
# environment for all agents in the gym_coursedesign world
class MultiAgentEnv(gym.Env):
    ...
    # def step(self, action_n):
        action_n = np.array((np.zeros(5), np.array([0,action_n[0],0,action_n[1],0])))
        obs_n = []
        reward_n = []
        done_n = []
        info_n = {'n': []}
    ...
    def render(self, mode='human'):
        ...
        for i in range(len(self.viewers)):
            ...
            if self.viewers[i] is None:
                ...
                from gym_coursedesign import rendering
